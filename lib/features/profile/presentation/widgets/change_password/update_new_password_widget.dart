...
import 'package:valetparking_driver/utils/formatters/formatter.dart';
      ...
      children: [
        ...
        TextFormFieldWidget(
          ...
          suffixIcon: IconButton(
            ...
            icon: SvgPicture.asset(
                !isShownOldPassword ? VImages.hideEyeIcon : VImages.showEyeIcon,
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    isOldPasswordFieldFocused
                        ? VColors.primaryColor500
        ...
        TextFormFieldWidget(
          ...
          suffixIcon: IconButton(
            ...
            icon: SvgPicture.asset(
                !isShownNewPassword ? VImages.hideEyeIcon : VImages.showEyeIcon,
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    isNewPasswordFieldFocused
                        ? VColors.primaryColor500
        ...
        /// Continue Button
        MainButtonWidget(
          centerWidgetInButton: Text('Update',
