    ...
    return Column(
      children: [
        ...
        MainButtonWidget(
          ...
          onTap: () => validatePasswords(context), /// Validate before proceeding
          margin: EdgeInsets.zero,
          buttonColor: newPasswordController.text.isEmpty || confirmNewPasswordController.text.isEmpty
              ? VColors.disabledButton
              : VColors.primaryColor500,
          boxShadow: newPasswordController.text.isEmpty || confirmNewPasswordController.text.isEmpty
              ? []
