    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(width: double.infinity, height: VDeviceUtils.getScreenHeight(context) / 26, child: Text(
                '${AppLocalizations.of(context)!.translate('cancelParking')}',
                style: VStyles.h4Bold(context).copyWith(color: VColors.alertsAndStatusError), textAlign: TextAlign.center)),
            ...
            SizedBox(width: double.infinity, height: VDeviceUtils.getScreenHeight(context) / 26, child: Text(
                '${AppLocalizations.of(context)!.translate('areYouSureYouWantToCancelYourParkingReservation')}',
                style: VStyles.h5Bold(context).copyWith(color: VColors.greyScale800), textAlign: TextAlign.center)),

            SizedBox(width: double.infinity, height: VDeviceUtils.getScreenHeight(context) / 26, child: Text(
                '${AppLocalizations.of(context)!.translate('only')}',
                style: VStyles.bodyMediumRegular(context).copyWith(color: VColors.greyScale800), textAlign: TextAlign.center)),
