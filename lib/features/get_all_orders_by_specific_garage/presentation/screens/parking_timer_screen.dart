...
// Function to convert DateTime to milliseconds (or seconds depending on your widget's needs)
  ...
  // DateTime _parseTime(String timeString) {
  //   try {
  //     final DateFormat timeFormat = DateFormat.jm(); // Format for "7:00 PM"
  //     return timeFormat.parse(timeString);
  //   } catch (e) {
  //     print("Error parsing time: $e");
  //     return DateTime.now(); // Fallback to current time if there's an error
  //   }
  // }
