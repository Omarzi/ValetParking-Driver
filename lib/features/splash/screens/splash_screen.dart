  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        decoration:
            BoxDecoration(gradient: AppGradients.gradientUltramarineBlue),
        child: Stack(
          children: [
            Column(
              ...
              children: [
                Center(
                  child: Stack(
                    children: [
                      SvgPicture.asset(VImages.appLogo,
            ...
            Positioned(
              ...
              bottom: 25.h,
              child: Lottie.asset(VImages.loadingLottie,
    ...
    Future.delayed(
      ...
      () {
        if (VCacheHelper.getString(key: CacheKeys.token) == '') {
          context.pushNamedAndRemoveUntil(VRoutesName.welcomeRoute,
              predicate: (route) => false);
        } else {
          logWarning(VCacheHelper.getString(key: CacheKeys.token)!);
          logWarning(VCacheHelper.getString(
            key: CacheKeys.garageId,
          )!);
          context.pushReplacementNamed(VRoutesName.navigationMenuRoute,
              arguments: 0);
        }
      },
    );
